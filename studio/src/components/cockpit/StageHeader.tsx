// 驾驶舱整体进度统计条（从 StageGrid 拆出）
// 顶栏：整体进度 + 当前阶段 + 状态图例 + 一键复制阶段概览。
...
/** 驾驶舱整体进度统计条：整体进度 / 当前阶段 / 状态图例 / 复制概览 */
export const StageHeader: React.FC<StageHeaderProps> = ({ stages, currentStage, loading }) => {
  // 整体进度统计（顶栏用）
